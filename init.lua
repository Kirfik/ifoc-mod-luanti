--------------------------------------------------------
-- Luanti :: Independent Flags of Countries Mod (ifoc)
--
-- See README.txt for licensing and other information.
-- Copyright (c) 2026, Kirfik
--------------------------------------------------------
...
local legacy_flag_list = {"un", "ac", "ad", "ae", "af", "ag", "ai", "al", "am", "ao", "aq", "ar", "as", "at", "au", "aw", "ax", "az", "ba", "bb", "bd", "be", "bf", "bg", "bh", "bi", "bj", "bl", "bm", "bn", "bo", "bq", "br", "bs", "bt", "bv", "bw", "by", "bz", "ca", "cc", "cd", "cefta", "cf", "cg", "ch", "ci", "ck", "cl", "cm", "cn", "co", "cp", "cr", "cu", "cv", "cw", "cx", "cy", "cz", "de", "dg", "dj", "dk", "dm", "do", "dz", "ea", "ec", "ee", "eg", "eh", "er", "es", "es-ct", "es-ga", "et", "eu", "fi", "fj", "fk", "fm", "fo", "fr", "ga", "gb","gb-eng", "gb-nir", "gb-sct", "gb-wls", "gd", "ge", "gf", "gg", "gh", "gi", "gl", "gm", "gn", "gp", "gq", "gr", "gs", "gt", "gu", "gw", "gy", "hk", "hm", "hn", "hr", "ht", "hu", "ic", "id", "ie", "il", "im", "in", "io", "iq", "ir", "is", "it", "je", "jm", "jo", "jp", "ke", "kg", "kh", "ki", "km", "kn", "kp", "kr", "kw", "ky", "kz", "la", "lb", "lc", "li", "lk", "lr", "ls", "lt", "lu", "lv", "ly", "ma", "mc", "md", "me", "mf", "mg", "mh", "mk", "ml", "mm", "mn", "mo", "mp", "mq", "mr", "ms", "mt", "mu", "mv", "mw", "mx", "my", "mz", "na", "nc", "ne", "nf", "ng", "ni", "nl", "no", "np", "nr", "nu", "nz", "om", "pa", "pe", "pf", "pg", "ph", "pk", "pl", "pm", "pn", "pr", "ps", "pt", "pw", "py", "qa", "re", "ro", "rs", "ru", "rw", "sa", "sb", "sc", "sd", "se", "sg", "sh", "si", "sj", "sk", "sl", "sm", "sn", "so", "sr", "ss", "st", "sv", "sx", "sy", "sz", "ta", "tc", "td", "tf", "tg", "th", "tj", "tk", "tl", "tm", "tn", "to", "tr", "tt", "tv", "tw", "tz", "ua", "ug", "um", "us", "uy", "uz", "va", "vc", "ve", "vg", "vi", "vn", "vu", "wf", "ws", "xk", "xx", "ye", "yt", "za", "zm", "zw",}
local flag_list = {"un", "ac", "ad", "ae", "af", "ag", "ai", "al", "am", "ao", "aq", "ar", "as", "at", "au", "aw", "ax", "az", "ba", "bb", "bd", "be", "bf", "bg", "bh", "bi", "bj", "bl", "bm", "bn", "bo", "bq", "br", "bs", "bt", "bv", "bw", "by", "bz", "ca", "cc", "cd", "cefta", "cf", "cg", "ch", "ci", "ck", "cl", "cm", "cn", "co", "cp", "cr", "cu", "cv", "cw", "cx", "cy", "cz", "de", "dg", "dj", "dk", "dm", "do", "dz", "ea", "ec", "ee", "eg", "eh", "er", "es", "es-ct", "es-ga", "et", "eu", "fi", "fj", "fk", "fm", "fo", "fr", "ga", "gb","gb-eng", "gb-nir", "gb-sct", "gb-wls", "gd", "ge", "gf", "gg", "gh", "gi", "gl", "gm", "gn", "gp", "gq", "gr", "gs", "gt", "gu", "gw", "gy", "hk", "hm", "hn", "hr", "ht", "hu", "ic", "id", "ie", "il", "im", "in", "io", "iq", "ir", "is", "it", "je", "jm", "jo", "jp", "ke", "kg", "kh", "ki", "km", "kn", "kp", "kr", "kw", "ky", "kz", "la", "lb", "lc", "li", "lk", "lr", "ls", "lt", "lu", "lv", "ly", "ma", "mc", "md", "me", "mf", "mg", "mh", "mk", "ml", "mm", "mn", "mo", "mp", "mq", "mr", "ms", "mt", "mu", "mv", "mw", "mx", "my", "mz", "na", "nc", "ne", "nf", "ng", "ni", "nl", "no", "np", "nr", "nu", "nz", "om", "pa", "pe", "pf", "pg", "ph", "pk", "pl", "pm", "pn", "pr", "ps", "pt", "pw", "py", "qa", "re", "ro", "rs", "ru", "rw", "sa", "sb", "sc", "sd", "se", "sg", "sh", "si", "sj", "sk", "sl", "sm", "sn", "so", "sr", "ss", "st", "sv", "sx", "sy", "sz", "ta", "tc", "td", "tf", "tg", "th", "tj", "tk", "tl", "tm", "tn", "to", "tr", "tt", "tv", "tw", "tz", "ua", "ug", "um", "us", "uy", "uz", "va", "vc", "ve", "vg", "vi", "vn", "vu", "wf", "ws", "xk", "xx", "ye", "yt", "za", "zm", "zw",}
...
if minetest.get_translator then
	S = minetest.get_translator("ifoc")
else
...
local delete_if_orphan = function( self )
	...
	if node.name ~= "ifoc:upper_mast" and node.name ~= "ignore" then
		minetest.log("action", "[ifoc] Orphan flag entity removed at "..minetest.pos_to_string(pos, 1))
		self.object:remove( )
		return true
	end
	return false
...
minetest.register_entity( "ifoc:wavingflag", {
	initial_properties = {
		physical = false,
		visual = "mesh",
		...
		pointable = false,
		mesh = "ifoc_wavingflag.b3d",
		textures = { "ifoc_un.png" },
	...
	on_activate = function ( self, staticdata, dtime )
		...
		for o=1, #objs do
			...
			if lua and self ~= lua and lua.name == "ifoc:wavingflag" then
	...
	reset_animation = function ( self, initial )
		local pos = self.object:get_pos( )
		local cur_wind = ifoc.get_wind( pos )
		minetest.log("verbose", "[ifoc] Current wind at "..minetest.pos_to_string(pos, 1)..": " .. cur_wind)
		local anim_speed
		local wave_sound

		if cur_wind < 10 then
			anim_speed = 10	-- 2 cycle
			wave_sound = "ifoc_flagwave1"
		elseif cur_wind < 20 then
			anim_speed = 20  -- 4 cycles
			wave_sound = "ifoc_flagwave1"
		elseif cur_wind < 40 then
			anim_speed = 40  -- 8 cycles
			wave_sound = "ifoc_flagwave2"
		else
			anim_speed = 80  -- 16 cycles
			wave_sound = "ifoc_flagwave3"
		end
	...
	reset_texture = function ( self, flag_name, nextprev )
		...
		local texture = string.format( "ifoc_%s.png", self.flag_name )
...
minetest.register_node( "ifoc:lower_mast", {
        description = S("Flag Pole"),
        drawtype = "mesh",
        paramtype = "light",
        mesh = "ifoc_mast_lower.obj",
        paramtype2 = "facedir",
        tiles = { "ifoc_baremetal.png", "ifoc_baremetal.png" },
        wield_image = "ifoc_pole_bottom_inv.png",
        inventory_image = "ifoc_pole_bottom_inv.png",
        groups = { cracky = 2 },
        sounds = metal_sounds,
...
local function rotate_flag_by_param2( flag, param2 )
	...
	if not baseyaw then
		minetest.log("warning", "[ifoc] Unsupported flag pole node param2: "..tostring(param2))
		return
	end
...
local function spawn_flag( pos )
	...
	local obj = minetest.add_entity( flag_pos, "ifoc:wavingflag" )
...
minetest.register_node( "ifoc:upper_mast", {
	description = S("Flag Pole with Flag"),
	drawtype = "mesh",
	paramtype = "light",
	mesh = "ifoc_mast_upper.obj",
	paramtype2 = "facedir",
	tiles = { "ifoc_baremetal.png", "ifoc_baremetal.png" },
	wield_image = "ifoc_pole_top_inv.png",
	inventory_image = "ifoc_pole_top_inv.png",
	groups = { cracky = 2 },
	sounds = metal_sounds,
	is_ground_content = false,
	...
	on_place = function( itemstack, placer, pointed_thing )
		...
		if not adef1 or (not adef1.buildable_to and anode1.name ~= "ifoc:upper_mast_hidden_1") then
			return itemstack
		end
		if not adef2 or (not adef2.buildable_to and anode2.name ~= "ifoc:upper_mast_hidden_2") then
			return itemstack
		end
		...
		minetest.set_node(pos, {name = "ifoc:upper_mast", param2 = param2 })
		minetest.set_node(above1, {name = "ifoc:upper_mast_hidden_1"})
		minetest.set_node(above2, {name = "ifoc:upper_mast_hidden_2"})

		if not (minetest.is_creative_enabled(pn)) then
			itemstack:take_item()
		end

		local def = minetest.registered_nodes["ifoc:upper_mast"]
	...
	after_destruct = function( pos )
		local above1 = {x=pos.x, y=pos.y+1, z=pos.z}
		local above2 = {x=pos.x, y=pos.y+2, z=pos.z}
		if minetest.get_node( above1 ).name == "ifoc:upper_mast_hidden_1" then
			minetest.remove_node( above1 )
		end
		if minetest.get_node( above2 ).name == "ifoc:upper_mast_hidden_2" then
...
minetest.register_lbm({
	name = "ifoc:respawn_flags",
	label = "Respawn flags",
	nodenames = {"ifoc:upper_mast"},
...
minetest.register_craft({
	output = "ifoc:upper_mast",
	recipe = {
		{"default:steel_ingot", "group:wool", "group:wool"},
		{"default:steel_ingot", "group:wool", "group:wool"},
		{"default:steel_ingot", "group:wool", "group:wool"},
	},
})
minetest.register_craft({
	output = "ifoc:upper_mast",
	recipe = {
		{"mcl_core:iron_ingot", "mcl_wool:white", "mcl_wool:white"},
		{"mcl_core:iron_ingot", "mcl_wool:white", "mcl_wool:white"},
		{"mcl_core:iron_ingot", "mcl_wool:white", "mcl_wool:white"},
	},
})
...
-- or destructed.
minetest.register_node( "ifoc:upper_mast_hidden_1", {
	drawtype = "airlike",
	pointable = false,
	paramtype = "light",
	sunlight_propagates = true,
	wield_image = "ifoc_pole_hidden1_inv.png",
	inventory_image = "ifoc_pole_hidden1_inv.png",
...
minetest.register_node( "ifoc:upper_mast_hidden_2", {
	drawtype = "airlike",
	pointable = false,
	paramtype = "light",
	sunlight_propagates = true,
	wield_image = "ifoc_pole_hidden2_inv.png",
	inventory_image = "ifoc_pole_hidden2_inv.png",
	groups = { not_in_creative_inventory = 1 },
	sounds = metal_sounds,
        collision_box = {
                type = "fixed",
...
ifoc.get_flags = function( )
	return table.copy( flag_list )
end

ifoc.set_flag_at = function( pos, flag_name )
	local node = minetest.get_node( pos )
	if node.name ~= "ifoc:upper_mast" then
		return false
	end
